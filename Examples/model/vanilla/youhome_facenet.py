...
class InceptionResnetV1(nn.Module):
    ...
    """
    def __init__(self, pretrained=None, classify=False, num_classes=9, dropout_prob=0.6, device=None):
        super().__init__()
...
if __name__ == "__main__":
    ...
    model = InceptionResnetV1(num_classes=9)
    input = torch.randn(2, 3, 160, 160)
