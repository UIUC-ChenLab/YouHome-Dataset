...
parser.add_argument('--test_dir',default='/mnt/echo/youhome/resnet_data_AllcameraTrain_c1test',type=str, help='./test_data')
...
def get_id(img_path):
    ...
    for path, v in img_path:
        ...
        if (temp[-1] == 's'):
            temp = temp[0]
        # print("camera_id", temp)
        # camera_id.append(int(camera[0]))
        camera_id.append(int(temp))
